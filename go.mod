...
replace (
	...
	github.com/lightninglabs/neutrino => github.com/breez/neutrino v0.11.1-0.20210509135317-60f5ecb30dce
	github.com/lightningnetwork/lnd => github.com/breez/lnd v0.11.0-beta.rc4.0.20210513144201-6273653c4049
