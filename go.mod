...
replace (
	...
	github.com/lightninglabs/neutrino => github.com/breez/neutrino v0.11.1-0.20200329111317-7eb0362b28e2
	github.com/lightningnetwork/lnd => github.com/breez/lnd v0.8.0-beta-rc3.0.20200329110355-fec5f81ae757
)
