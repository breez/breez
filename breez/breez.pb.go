...
type PaySwapInvoiceRequest struct {
	PaymentRequest string `protobuf:"bytes,1,opt,name=paymentRequest" json:"paymentRequest,omitempty"`
}

func (m *PaySwapInvoiceRequest) Reset()                    { *m = PaySwapInvoiceRequest{} }
func (m *PaySwapInvoiceRequest) String() string            { return proto.CompactTextString(m) }
func (*PaySwapInvoiceRequest) ProtoMessage()               {}
func (*PaySwapInvoiceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

func (m *PaySwapInvoiceRequest) GetPaymentRequest() string {
	if m != nil {
...
type PaySwapInvoiceReply struct {
	Preimage string `protobuf:"bytes,1,opt,name=preimage" json:"preimage,omitempty"`
}

func (m *PaySwapInvoiceReply) Reset()                    { *m = PaySwapInvoiceReply{} }
func (m *PaySwapInvoiceReply) String() string            { return proto.CompactTextString(m) }
func (*PaySwapInvoiceReply) ProtoMessage()               {}
func (*PaySwapInvoiceReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }

func (m *PaySwapInvoiceReply) GetPreimage() string {
	if m != nil {
		return m.Preimage
	}
	return ""
...
func (m *GetRefundsRequest) String() string            { return proto.CompactTextString(m) }
func (*GetRefundsRequest) ProtoMessage()               {}
func (*GetRefundsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }

func (m *GetRefundsRequest) GetNotificationToken() string {
	if m != nil {
		return m.NotificationToken
	}
	return ""
...
type GetRefundsReply struct {
	Refunds map[string]*GetRefundsReply_RefundStatus `protobuf:"bytes,1,rep,name=refunds" json:"refunds,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *GetRefundsReply) Reset()                    { *m = GetRefundsReply{} }
func (m *GetRefundsReply) String() string            { return proto.CompactTextString(m) }
func (*GetRefundsReply) ProtoMessage()               {}
func (*GetRefundsReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }

func (m *GetRefundsReply) GetRefunds() map[string]*GetRefundsReply_RefundStatus {
	if m != nil {
		return m.Refunds
	}
	return nil
...
type GetRefundsReply_RefundStatus struct {
	Tx        string `protobuf:"bytes,1,opt,name=tx" json:"tx,omitempty"`
	Amount    int64  `protobuf:"varint,2,opt,name=amount" json:"amount,omitempty"`
	BlockHash string `protobuf:"bytes,4,opt,name=blockHash" json:"blockHash,omitempty"`
}

func (m *GetRefundsReply_RefundStatus) Reset()         { *m = GetRefundsReply_RefundStatus{} }
func (m *GetRefundsReply_RefundStatus) String() string { return proto.CompactTextString(m) }
func (*GetRefundsReply_RefundStatus) ProtoMessage()    {}
func (*GetRefundsReply_RefundStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{13, 0}
}

func (m *GetRefundsReply_RefundStatus) GetTx() string {
	if m != nil {
		return m.Tx
	}
	return ""
...
func (m *GetRefundsReply_RefundStatus) GetAmount() int64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
func (m *GetRefundsReply_RefundStatus) GetBlockHash() string {
	if m != nil {
		return m.BlockHash
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*PaySwapInvoiceRequest)(nil), "breez.PaySwapInvoiceRequest")
	proto.RegisterType((*PaySwapInvoiceReply)(nil), "breez.PaySwapInvoiceReply")
	...
	proto.RegisterType((*GetRefundsRequest)(nil), "breez.GetRefundsRequest")
	proto.RegisterType((*GetRefundsReply)(nil), "breez.GetRefundsReply")
	proto.RegisterType((*GetRefundsReply_RefundStatus)(nil), "breez.GetRefundsReply.RefundStatus")
...
type FundManagerClient interface {
	...
	PaySwapInvoice(ctx context.Context, in *PaySwapInvoiceRequest, opts ...grpc.CallOption) (*PaySwapInvoiceReply, error)
	GetRefunds(ctx context.Context, in *GetRefundsRequest, opts ...grpc.CallOption) (*GetRefundsReply, error)
}
...
func (c *fundManagerClient) PaySwapInvoice(ctx context.Context, in *PaySwapInvoiceRequest, opts ...grpc.CallOption) (*PaySwapInvoiceReply, error) {
	out := new(PaySwapInvoiceReply)
	err := grpc.Invoke(ctx, "/breez.FundManager/PaySwapInvoice", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fundManagerClient) GetRefunds(ctx context.Context, in *GetRefundsRequest, opts ...grpc.CallOption) (*GetRefundsReply, error) {
	out := new(GetRefundsReply)
	err := grpc.Invoke(ctx, "/breez.FundManager/GetRefunds", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FundManagerServer interface {
	...
	PaySwapInvoice(context.Context, *PaySwapInvoiceRequest) (*PaySwapInvoiceReply, error)
	GetRefunds(context.Context, *GetRefundsRequest) (*GetRefundsReply, error)
}
...
func _FundManager_PaySwapInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PaySwapInvoiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FundManagerServer).PaySwapInvoice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.FundManager/PaySwapInvoice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FundManagerServer).PaySwapInvoice(ctx, req.(*PaySwapInvoiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _FundManager_GetRefunds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRefundsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FundManagerServer).GetRefunds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.FundManager/GetRefunds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FundManagerServer).GetRefunds(ctx, req.(*GetRefundsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FundManager_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PaySwapInvoice",
			Handler:    _FundManager_PaySwapInvoice_Handler,
		},
		{
			MethodName: "GetRefunds",
			Handler:    _FundManager_GetRefunds_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "breez.proto",
...
var fileDescriptor0 = []byte{
	...
	,
}
