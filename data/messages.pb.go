...
type AddressInfo struct {
	...
	ConfirmedBalance   int64   `protobuf:"varint,1,opt,name=confirmedBalance,proto3" json:"confirmedBalance,omitempty"`
	UnconfirmedBalance int64   `protobuf:"varint,2,opt,name=unconfirmedBalance,proto3" json:"unconfirmedBalance,omitempty"`
...
var file_messages_proto_rawDesc = []byte{
	...
	,
...
var file_messages_proto_depIdxs = []int32{
	...
	81, // 6: data.SpontaneousPaymentRequest.tlv:type_name -> data.SpontaneousPaymentRequest.TlvEntry
	...
	82, // 22: data.LSPList.lsps:type_name -> data.LSPList.LspsEntry
	83, // 23: data.LSPActivity.activity:type_name -> data.LSPActivity.ActivityEntry
	...
	84, // 36: data.ClaimFeeEstimates.fees:type_name -> data.ClaimFeeEstimates.FeesEntry
	85, // 37: data.SweepAllCoinsTransactions.transactions:type_name -> data.SweepAllCoinsTransactions.TransactionsEntry
	78, // 38: data.AddressInfo.utxos:type_name -> data.Utxo
	46, // 39: data.LSPList.LspsEntry.value:type_name -> data.LSPInformation
	74, // 40: data.SweepAllCoinsTransactions.TransactionsEntry.value:type_name -> data.TransactionDetails
	48, // 41: data.BreezAPI.GetLSPList:input_type -> data.LSPListRequest
	51, // 42: data.BreezAPI.ConnectToLSP:input_type -> data.ConnectLSPRequest
	7,  // 43: data.BreezAPI.AddFundInit:input_type -> data.AddFundInitRequest
	8,  // 44: data.BreezAPI.GetFundStatus:input_type -> data.FundStatusRequest
	19, // 45: data.BreezAPI.AddInvoice:input_type -> data.AddInvoiceRequest
	16, // 46: data.BreezAPI.PayInvoice:input_type -> data.PayInvoiceRequest
	5,  // 47: data.BreezAPI.RestartDaemon:input_type -> data.RestartDaemonRequest
	4,  // 48: data.BreezAPI.ListPayments:input_type -> data.ListPaymentsRequest
	49, // 49: data.BreezAPI.GetLSPList:output_type -> data.LSPList
	52, // 50: data.BreezAPI.ConnectToLSP:output_type -> data.ConnectLSPReply
	26, // 51: data.BreezAPI.AddFundInit:output_type -> data.AddFundInitReply
	30, // 52: data.BreezAPI.GetFundStatus:output_type -> data.FundStatusReply
	9,  // 53: data.BreezAPI.AddInvoice:output_type -> data.AddInvoiceReply
	14, // 54: data.BreezAPI.PayInvoice:output_type -> data.PaymentResponse
	6,  // 55: data.BreezAPI.RestartDaemon:output_type -> data.RestartDaemonReply
	13, // 56: data.BreezAPI.ListPayments:output_type -> data.PaymentsList
