...
type SendSwapInvoiceRequest struct {
	Address string `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Tx      string `protobuf:"bytes,2,opt,name=tx" json:"tx,omitempty"`
	Value   int64  `protobuf:"varint,3,opt,name=value" json:"value,omitempty"`
}

func (m *SendSwapInvoiceRequest) Reset()                    { *m = SendSwapInvoiceRequest{} }
func (m *SendSwapInvoiceRequest) String() string            { return proto.CompactTextString(m) }
func (*SendSwapInvoiceRequest) ProtoMessage()               {}
func (*SendSwapInvoiceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }

func (m *SendSwapInvoiceRequest) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *SendSwapInvoiceRequest) GetTx() string {
	if m != nil {
		return m.Tx
	}
	return ""
...
func (m *SendSwapInvoiceRequest) GetValue() int64 {
	if m != nil {
		return m.Value
	}
	return 0
...
func (*Invoice) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*NotificationEvent) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (m *AddFundReply) GetBackupJson() string {
	if m != nil {
		return m.BackupJson
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*SendSwapInvoiceRequest)(nil), "data.SendSwapInvoiceRequest")
...
var fileDescriptor0 = []byte{
	...
	,
}
